...
class SPTraderSpi(sptraderapi.CTORATstpSPTraderSpi):
    ...
    def OnRspQryMarketData(self, pMarketData, pRspInfo, nRequestID, bIsLast):
        print("OnRspQryMarketData: ErrorID[%d] ErrorMsg[%s] RequestID[%d] IsLast[%d]" %(
                                                            pRspInfo['ErrorID'],
                                                            pRspInfo['ErrorMsg'],
                                                            nRequestID,
                                                            bIsLast))
        ...
        if bIsLast!=1:
            print("SecurityID[%s] SecurityName[%s] PreClosePrice[%s] OpenPrice[%s] LastPrice[%s] HighestPrice[%s] LowestPrice[%s] UpdateTime[%s]" % (
    ...
    def test_req_qry_market_data(self):
        ...
        qry_market_data_field.SecurityID='110121371'
